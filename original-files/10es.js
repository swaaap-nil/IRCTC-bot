    ...
    [10],
    {
        NSaA: function (e, t, n) {
                        ...
                        template: function (e, t) {
                            1 & e &&
                                ...
                                2 & e &&
                                    ...
                                    o.Cb(1),
                                    o.Pc(o.yc(28, D)),
                                    o.tc('visible', t.reTryBooking)('responsive', !0)(
                                        'closable',
                                        !1
                                    )('closeOnEscape', !1),
                                    o.Cb(8),
                ...
                if (
                    ...
                    o.Cb(2),
                        o.Wc(
                            ...
                            ' ',
                            o.qc(3, 2, e.ewallet.currentBalance, 'INR', !0),
                            ''
                        )
                }
            }
            ...
            function Lt(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc(5)
                    o.Cb(1), o.tc('enableService', !1)('value', e.msgsLowBalance)('closable', !1)
                }
            }
            function Nt(e, t) {
            ...
            function Sn(e, t) {
                if (1 & e) {
                    ...
                    o.ac(0, 'p-sidebar', 79),
                        ...
                        o.ac(5, 'div', 84),
                        o.ic('click', function () {
                            return o.Kc(e), (o.mc().showBankListMob = !1)
                        }),
                        o.Zb(),
                        o.ac(6, 'div', 85),
                        o.ac(7, 'strong'),
                ...
                if (2 & e) {
                    const e = o.mc()
                    o.tc('visible', e.showBankListMob)('fullScreen', !0)('baseZIndex', 1e4),
                        o.Cb(8),
            ...
            function Dn(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc()
                    o.tc('modal', !1)('visible', !0)('ngStyle', o.yc(5, Tn)),
                        o.Cb(2),
                        o.tc('ngIf', !e.forEwallet),
                        o.Cb(3),
                        o.Vc(
            ...
            function wn(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc()
                    o.tc('modal', !1)('visible', !0)('ngStyle', o.yc(4, Tn)),
                        o.Cb(4),
                        o.Uc(null == e.langService.lang ? null : e.langService.lang.makePayment)
                }
            }
            ...
            function Mn(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc()
                    o.tc('modal', !1)('visible', !0)('ngStyle', o.yc(8, Tn)),
                        o.Cb(4),
                        o.Vc(
                            ' \u20b9 ',
                ...
                class e {
                    constructor(e, t, n, a, i, c, s, l, r, g) {
                        ;(this.router = e),
                            ...
                            (this.cardInputFlag = !1),
                            (this.paymentMode = new x()),
                            (this.error = !0),
                            (this.showPref = !1),
                            (this.bankListdto = new E()),
                            (this.captchaType = 'PAYMENT'),
                            (this.txnPasswordMandate = !1),
                            (this.msgsLoyality = []),
                            (this.msgsLowBalance = []),
                            (this.msgsDisableReason = []),
                            (this.showHdfc = !1),
                            (this.paymentInitiated = !1),
                            (this.ftPymntMsgFlag = !1),
                            (this.charCount = 0),
                            (this.shMsg = {
                                cc_dc: !1,
                                dcp: !1,
                                showLoyalityMessage: !1,
                                upiAgRdsFlag: !1
                            }),
                            (this.showBankListMob = !1),
                            (this.softFlag = !1),
                            (this.fetchPref = !1),
                        ...
                        this.fetchPref && this.fetchPreferredBankList(),
                            ...
                            null != this.bankList &&
                                ...
                                this.msgsDisableReason.push({
                                    severity: 'error',
                                    detail: this.bankList[this.paymentMode.EWALLET][0].disableReason
                                }),
                    ...
                    fetchPreferredBankList() {
                        this.paymentService.fetchPreferredBankList().subscribe((e) => {
                            if (
                                ...
                                } else this.showPref = !0
                                this.error = !0
                            }
                        })
                    }
                    goBack() {
                        ;(this.commonService.reviewPage = !0),
                    ...
                    setPreferredBankList() {
                        if (
                            ...
                            console.log('this.preferredbankList:::::  ' + this.preferredbankList),
                                this.preferredbankList.length > 0 && (this.showPref = !0)
                        }
                    }
                    onSelectBank(e) {
                        if (null != e || null != e) {
                        ...
                        template: function (e, t) {
                            1 & e &&
                                ...
                                2 & e &&
                                    ...
                                    o.Cb(1),
                                    o.tc('modal', !1)('visible', !0)('ngStyle', o.yc(16, Tn)),
                                    o.Cb(2),
                ...
                class e {
                    ...
                    ngOnInit() {
                        this.store.select(c.h).subscribe((e) => {
                            ...
                            this.commonService.bankErrorFlag &&
                                ...
                                (this.commonService.bankErrorFlag = !1)),
                    ...
                    ngAfterViewInit() {
                        this.langService.isAdsEnable &&
                            ...
                            (this.commonService.reviewPage = !1),
                    ...
                    makePayment(e) {
                        ;(this.langService.loader = !0),
                            console.log('makePayment()-----\x3e ' + JSON.stringify(e))
                                    ...
                                    (e) => {
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                console.log(' RDS'), (this.langService.loader = !0)
                                                let e =
                    ...
                    goBack() {
                        ;(this.commonService.reviewPage = !0), this._location.back()
                    }
                    showMsg(e) {
                        ;(this.shMsg = e),
                            (this.msg = !1),
                    ...
                    (e.ɵcmp = o.Ob({
                        ...
                        template: function (e, t) {
                            ...
                            2 & e &&
                                ...
                                o.Cb(9),
                                o.Uc(
                                    null == t.langService.lang ? null : t.langService.lang.payMethod
                                ),
                                o.Cb(3),
                                o.Xc(
                                    ' ',
                                ...
                                o.tc('bankDetail', t.bankDetailDTO)(
                                    'preferedBankDetail',
                                    t.preferredbankList
                                )('fetchPref', !1)('softPaymentDTO', t.softPaymentDTO)(
                                    'softPaymentDTOs',
                                    t.softPaymentDTOs
                                )(
                                    'ewallet',
                                ...
                                o.tc('id', t.adIdPOB),
                                o.Cb(3),
                                o.tc('avlY', !0)('journeyDetails', t.journeyDetails),
                                o.Cb(1),
            ...
            function ya(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc(2)
                    o.tc('forEwallet', !0)('bankDetail', e.bankDetailDTO)('fetchPref', !0)(
                        'ewallet',
                        e.ewalletDTO
                    )
                }
                            ...
                            ;(this.initSuccess = !1),
                                ...
                                this.paymentService.initLoyaltyPurchasePoiints().subscribe((t) => {
                                    console.log(
                                        ...
                                        (this.loadingBankList = !1)
                                })
                        } else (this.loadingBankList = !1), (this.initSuccess = !1)
                    }
                    initGstControl() {
            ...
            function Oa(e, t) {
                ...
                if (2 & e) {
                    const e = o.mc(2)
                    o.tc('fetchPref', !1)('bankDetail', e.bankDetailDTO)
                }
            }
            function Ea(e, t) {
                if (1 & e) {
                ...
                class e {
                    constructor(e, t, n, a, i, c, s) {
                        ;(this.router = e),
                            ...
                            (this.verifypayment = !1),
                            (this.paymentRequire = !0),
                            (this.registerSuccess = !1),
                            (this.ewalletDocumentinput = !1),
                            (this.loading = !1),
                            (this.regType = 'pancardflg'),
                            (this.zeroPaymentVerify = !1),
                    ...
                    checkewalletreginput() {
                        if (
                            ...
                            return (
                                ...
                                void (this.langService.loader = !1)
                            )
                        ...
                        template: function (e, t) {
                            1 & e &&
                                ...
                                2 & e &&
                                    ...
                                    o.tc('ngIf', t.verifypayment || t.registerSuccess),
                                    o.Cb(3),
                                    o.tc('visible', t.registerSuccess)('closable', !1),
                                    o.Cb(1),
                                    o.Wc(
                                        ' ',
                                        null == t.langService.lang
            ...
            function Ua(e, t) {
                ...
                if (2 & e) {
                    ...
                    o.Cb(2),
                        ...
                        o.Cb(2),
                        o.Uc(o.qc(13, 18, e.eWalletDepositPaymentDetail.balance, 'INR', !0)),
                        o.Cb(5),
                        o.Vc(
                            '',
                        ...
                        o.Cb(2),
                        o.Uc(o.qc(25, 22, e.minDepositAmount, 'INR', !0)),
                        o.Cb(2),
                        o.Vc(
                            ' ',
                        ...
                        o.Cb(2),
                        o.Uc(o.qc(29, 26, e.maxDepositAmount, 'INR', !0)),
                        o.Cb(9),
                        o.Vc(
                            '',
                            null == e.langService.lang
                        ...
                        template: function (e, t) {
                            1 & e &&
                                ...
                                2 & e &&
                                    ...
                                    o.Cb(1),
                                    o.tc('bankDetail', t.bankDetailDTO)('fetchPref', !0),
                                    o.Cb(2),
                                    o.Uc(t.errorMessage))
                        },
                    ...
                    ngOnInit() {
                        ;(this.verifyUser = !1),
                            ...
                            94 != this.userResponse.countryId
                                ? ((this.isInternationalUser = !0), this.initGstControl())
                                : (this.isInternationalUser = !1)
                    }
                    makePayment(e) {
                        if (
                        ...
                        template: function (e, t) {
                            1 & e &&
                                ...
                                2 & e &&
                                    ...
                                    o.Cb(1),
                                    o.tc('forEwallet', !0)('bankDetail', t.bankDetailDTO)(
                                        'fetchPref',
                                        !1
                                    ))
                        },
                    ...
                    ngOnInit() {
                        ;(this.bkgRespDto = this.bookingService.bookingResponse),
                            ...
                            null != this.bkgRespDto && null == this.bkgRespDto.errorMessage
                                ? (this.bookingSuccess = !0)
                                : ((this.bookingSuccess = !1), (this.langService.loader = !1))
                    }
                }
                return (
                    (e.ɵfac = function (t) {
                    ...
                    component: (() => {
                        class e {
                            ...
                            validateEmailInput() {
                                ...
                                return (
                                    console.log('registeredEmailId--\x3e' + this.emailId),
                                    '' === e && '' === t
                                        ? ((this.errorMsg =
