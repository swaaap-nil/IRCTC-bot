            ...
            e.exports = function (e, t) {
                ...
                if ((n = g ? r : y ? r[d] || a(d, {}) : (r[d] || {}).prototype))
                    for (u in t) {
                        if (
                            ((p = t[u]),
                            (f = e.noTargetGet ? (h = o(n, u)) && h.value : n[u]),
                            !l(g ? u : d + (y ? '.' : '#') + u, e.forced) && void 0 !== f)
                        ) {
        ...
        busE: function (e, t, n) {
            ...
            ;(e.exports = function (e, t, n, a) {
                ...
                'function' == typeof n &&
                    ...
                    (c = u(n)).source || (c.source = f.join('string' == typeof t ? t : ''))),
                    e !== r
                        ? (l ? !h && e[t] && (p = !0) : delete e[t], p ? (e[t] = n) : o(e, t, n))
                        : p
                          ? (e[t] = n)
                          : s(t, n)
            ...
            void 0 ===
                (o =
                    ...
                    typeof (r = function () {
                                    ...
                                    try {
                                        ...
                                        e.state !== _ &&
                                            ...
                                            (e.type == x || (e.data && e.data.isPeriodic)
                                                ? r && e._transitionTo(T, w)
                                                : ((e.runCount = 0),
                                                  this._updateTaskCount(e, -1),
                                                  r && e._transitionTo(_, w, _))),
                                            (j = j.parent),
                                            (R = o)
                                    }
                                }
                        ...
                        function E(e, t, n) {
                            if (t) for (let r = 0; r < t.length; r++) w(e, 'on' + t[r], n)
                            else {
                                const t = []
                        ...
                        function O(e) {
                            ...
                            for (o in n)
                                'prototype' !== o && n.hasOwnProperty(o) && (h[e][o] = n[o])
                        }
                                    ...
                                    A = function (t, n, o, i, s = !1, a = !1) {
                                        return function () {
                                            ...
                                            return (
                                                ...
                                                N && (N.taskData = null),
                                                m && (d.once = !0),
                                                (z || 'boolean' != typeof A.options) &&
                                                    (A.options = d),
                                                (A.target = c),
                                                (A.capture = v),
                                                (A.eventName = l),
                                                f && (A.originalDelegate = u),
                                                a ? O.unshift(A) : O.push(A),
                                                s ? c : void 0
                                            )
                                        }
                                    }
                        ...
                        function re(e, t) {
                            ...
                            if (m) {
                                ...
                                ne(e, ee.concat(['messageerror']), o ? o.concat(t) : o, n(e)),
                                    ...
                                    ne(HTMLMediaElement.prototype, W, o),
                                    ne(HTMLFrameSetElement.prototype, U.concat(Y), o),
                                    ne(HTMLBodyElement.prototype, U.concat(Y), o),
                                    ne(HTMLFrameElement.prototype, q, o),
                                    ne(HTMLIFrameElement.prototype, q, o)
